...
export function alternativesProviderForAddingChild(modelNode: ModelNode, containmentName: string, replacing: boolean = false) {
...
export function installAutocomplete(vnode: any, valuesProvider: (arg0: (suggestions: any) => void) => void, fixed: boolean) {
